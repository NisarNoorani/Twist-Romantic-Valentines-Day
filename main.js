document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Ali"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">Tum free me hath lagana ❤️</span>`;
